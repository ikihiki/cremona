...
public:
  ...
  virtual bool replace(int id, void *new_one, void **replaced_entry,
                       crmna_err_t *err) = 0;
  virtual bool remove(int id, void **removed_entry, crmna_err_t *err) = 0;
...
private:
  ...
  static bool replace(void *obj, int id, void *new_one, void **replaced_entry,
                      crmna_err_t *err);
  static bool remove(void *obj, int id, void **removed_entry, crmna_err_t *err);
...
public:
  ...
  MOCK_METHOD4(replace, bool(int id, void *new_one, void **replaced_entry,
                             crmna_err_t *err));
  MOCK_METHOD3(remove, bool(int id, void **removed_entry, crmna_err_t *err));
